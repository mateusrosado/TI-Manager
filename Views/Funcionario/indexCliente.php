...
<body class="home">
  ...
  <div class="container">
    ...
    <div class="section-title">
      <div>Fazendo</div>
      <button class="btn-tarefa" onclick="window.location.href='../Cliente_addchamado/'">+</button>
    </div>
    ...
    <div class="card">
      ...
      <button class="btn-tarefa"onclick="window.location.href='../Cliente_editar/'">Editar</button>
    </div>
